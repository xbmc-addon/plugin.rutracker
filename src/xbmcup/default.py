        ...
        if data is None:
            ...
            for id in data['data']:
                ...
                if movie:
                    ...
                    # вывод
                    self.item(Link('rutracker-search', {'content': 'movie', 'search': search}), title=movie['info']['title'], thumb=movie['thumb'], media='video', info=movie['info'], popup=popup, popup_replace=True, total=total)
